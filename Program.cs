...
namespace Dio.Series
{
  class Program
  {
    ...
    static void Main(string[] args)
    {
      ...
      System.Console.WriteLine("Obrigada por utilizar nossos serviços!");
      Console.ReadLine();
    }

    //MÉTODO LISTAR SERIES
    ...
    //MÉTODO DE ATUALIZAR UMA SÉRIE JÁ INSERIDA
    ...
    private static void ExcluirSerie()
    {
      ...
      //inserir melhoria de confirmação

      repositorio.Exclui(indiceSerie);
    }

    //METODO PARA VISUALIZAR A SERIE
    ...
    private static string ObterOpcaoUsuario()
    {
      ...
      System.Console.WriteLine("Cadaste suas séries de forma simples!");
